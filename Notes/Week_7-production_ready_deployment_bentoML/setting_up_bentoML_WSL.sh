...
# P.S. Trying to install docker compose plugins on its own didnt work as instruced here:https://docs.docker.com/compose/install/linux/
# Instead, running the whole portion below solved the problem.

...
## 0. [Miscelleanous commands for git, bash and using different cloud notebooks](./Week_0-misc_git_documentation/readme.md)
I will keep adding stuff related to git and bash commands here that are needed as a pre-requisite for the course.
<!--- ### [Notes]() --->

## 1. [Introduction to Machine Learning](./Week_1-intro_to_ML_linear_algebra)

### Notes: [Click here](./Week_1-intro_to_ML_linear_algebra/Notes_for_Chapter_1-Linear_Algebra.ipynb)

### Homework Solution:  [Click here](../HW/HW1/MLZoomCamp22_HW1_MemoonaTahira.ipynb)
...
- 1.5 [Model Selection Process](https://github.com/DataTalksClub/machine-learning-zoomcamp/blob/master/01-intro/05-model-selection.md)
...
## 2. [Machine Learning for Regression](./Week_2-linear_regression/)

### Notes: [Click here](./Week_2-linear_regression/readme.md)

### Homework Solution:  [Click here](../HW/HW2/HW2-Linear_Regression.ipynb)
...
## 3. [Machine Learning for Classification](./Week_3-logistic_regression_classification/)

### Notes: [Click here](./Week_3-logistic_regression_classification/readme.md)

### Homework:  [Click here](../HW/HW3/Week3-Classification.ipynb)
...
## 4. [Evaluation Metrics for Classification](./Week_4%20-evaluation_metrics_for_ML_model/)

### Notes: [Click here](./Week_4%20-evaluation_metrics_for_ML_model/readme.md)

### Homework Solution:  [Click here](../HW/HW4/Week_4-Evaluation.ipynb)
...
## 5. [Deploying Machine Learning Models](./Week_5-flask_and_docker_for_deployment/)

### Notes: [Click here](./Week_5-flask_and_docker_for_deployment/readme.md)

### Homework Solution:  [Click here](../HW/HW5/HW5_Solution.ipynb)

### Topics covered: 

- 5.1 [Intro / Session overview](https://github.com/DataTalksClub/machine-learning-zoomcamp/blob/master/05-deployment/01-intro.md)
- 5.2 [Saving and loading the model](https://github.com/DataTalksClub/machine-learning-zoomcamp/blob/master/05-deployment/02-pickle.md)
- 5.3 [Web services: introduction to Flask](https://github.com/DataTalksClub/machine-learning-zoomcamp/blob/master/05-deployment/03-flask-intro.md)
- 5.4 [Serving the churn model with Flask](https://github.com/DataTalksClub/machine-learning-zoomcamp/blob/master/05-deployment/04-flask-deployment.md)
- 5.5 [Python virtual environment: Pipenv](https://github.com/DataTalksClub/machine-learning-zoomcamp/blob/master/05-deployment/05-pipenv.md)
- 5.6 [Environment management: Docker](https://github.com/DataTalksClub/machine-learning-zoomcamp/blob/master/05-deployment/06-docker.md)
- 5.7 [Deployment to the cloud: AWS Elastic Beanstalk (optional)](https://github.com/DataTalksClub/machine-learning-zoomcamp/blob/master/05-deployment/07-aws-eb.md)
- 5.8 [Summary](https://github.com/DataTalksClub/machine-learning-zoomcamp/blob/master/05-deployment/08-summary.md)
- 5.9 [Explore more](https://github.com/DataTalksClub/machine-learning-zoomcamp/blob/master/05-deployment/09-explore-more.md)



## 6. [Decision Trees and Ensemble Learning](./Week_6-decision_trees_and_ensemble_models/)

### Notes: [Click here](./Week_6-decision_trees_and_ensemble_models/readme.md)

### Homework Solution:  [Click here](../HW/HW6/HW6-decision_trees.ipynb)
...
## 7. [Production-Ready Machine Learning (BentoML)](./Week_7-production_ready_deployment_bentoML/)
...
- 7.1 [Intro/Session Overview](https://github.com/DataTalksClub/machine-learning-zoomcamp/blob/master/07-bentoml-production/01-intro.md)
- 7.2 [Building Your Prediction Service with BentoML](https://github.com/DataTalksClub/machine-learning-zoomcamp/blob/master/07-bentoml-production/02-build-bento-service.md)
- 7.3 [Deploying Your Prediction Service](https://github.com/DataTalksClub/machine-learning-zoomcamp/blob/master/07-bentoml-production/03-deploy-bento-service.md)
- 7.4 [Sending, Receiving and Validating Data](https://github.com/DataTalksClub/machine-learning-zoomcamp/blob/master/07-bentoml-production/04-validation.md)
- 7.5 [High-Performance Serving](https://github.com/DataTalksClub/machine-learning-zoomcamp/blob/master/07-bentoml-production/05-high-performance.md)
- 7.6 [Bento Production Deployment](https://github.com/DataTalksClub/machine-learning-zoomcamp/blob/master/07-bentoml-production/06-production-deployment.md)
- 7.7 [(Optional) Advanced Example: Deploying Stable Diffusion Model](https://github.com/DataTalksClub/machine-learning-zoomcamp/blob/master/07-bentoml-production/07-stable-diffusion.md)
- 7.8 [Summary](https://github.com/DataTalksClub/machine-learning-zoomcamp/blob/master/07-bentoml-production/08-summary.md)
...
## 8. [Neural Networks and Deep Learning](./Week_8-Deep_Learning/)
...
## 9. [Serverless Deep Learning](./Week_9-Serverless/)

### Notes for Week 9: [Click here](./Week_9-Serverless/)
### Homework for Week 9:  [Click here](../HW/HW9/)
### Topics covered: 
...
- 9.7 [API Gateway: exposing the lambda function](https://github.com/DataTalksClub/machine-learning-zoomcamp/blob/master/09-serverless/07-api-gateway.md)
...
- 10.1 [Overview](https://github.com/DataTalksClub/machine-learning-zoomcamp/blob/master/10-kubernetes/01-overview.md)
- 10.2 [TensorFlow Serving](https://github.com/DataTalksClub/machine-learning-zoomcamp/blob/master/10-kubernetes/02-tensorflow-serving.md)
- 10.3 [Creating a pre-processing service](https://github.com/DataTalksClub/machine-learning-zoomcamp/blob/master/10-kubernetes/03-preprocessing.md)
- 10.4 [Running everything locally with Docker-compose](https://github.com/DataTalksClub/machine-learning-zoomcamp/blob/master/10-kubernetes/04-docker-compose.md)
- 10.5 [Introduction to Kubernetes](https://github.com/DataTalksClub/machine-learning-zoomcamp/blob/master/10-kubernetes/05-kubernetes-intro.md)
- 10.6 [Deploying a simple service to Kubernetes](https://github.com/DataTalksClub/machine-learning-zoomcamp/blob/master/10-kubernetes/06-kubernetes-simple-service.md)
- 10.7 [Deploying TensorFlow models to Kubernetes](https://github.com/DataTalksClub/machine-learning-zoomcamp/blob/master/10-kubernetes/07-kubernetes-tf-serving.md)
- 10.8 [Deploying to EKS](https://github.com/DataTalksClub/machine-learning-zoomcamp/blob/master/10-kubernetes/08-eks.md)
- 10.9 [Summary](https://github.com/DataTalksClub/machine-learning-zoomcamp/blob/master/10-kubernetes/09-summary.md)
- 10.10 [Explore more](https://github.com/DataTalksClub/machine-learning-zoomcamp/blob/master/10-kubernetes/10-explore-more.md)
...
### Homework for Week 11:  [Click here](./imgs/giphy.gif)
### Topics covered: 
--->
- 11.1 [Overview](https://github.com/DataTalksClub/machine-learning-zoomcamp/blob/master/11-kserve/01-overview.md)
- 11.2 [Running KServe locally](https://github.com/DataTalksClub/machine-learning-zoomcamp/blob/master/11-kserve/02-kserve-local.md)
- 11.3 [Deploying a Scikit-Learn model with KServe](https://github.com/DataTalksClub/machine-learning-zoomcamp/blob/master/11-kserve/03-kserve-sklearn.md)
- 11.4 [Deploying custom Scikit-Learn images with KServe](https://github.com/DataTalksClub/machine-learning-zoomcamp/blob/master/11-kserve/04-kserve-custom-image.md)
- 11.5 [Serving TensorFlow models with KServe](https://github.com/DataTalksClub/machine-learning-zoomcamp/blob/master/11-kserve/05-tensorflow-kserve.md)
- 11.6 [KServe transformers](https://github.com/DataTalksClub/machine-learning-zoomcamp/blob/master/11-kserve/06-kserve-transformers.md)
- 11.7 [Deploying with KServe and EKS](https://github.com/DataTalksClub/machine-learning-zoomcamp/blob/master/11-kserve/07-kserve-eks.dm)
- 11.8 [Summary](https://github.com/DataTalksClub/machine-learning-zoomcamp/blob/master/11-kserve/08-summary.md)
